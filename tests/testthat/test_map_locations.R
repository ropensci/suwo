...
test_that("map markers and cluster", {
  ...
  a <- map_locations(metadata = df1, type = "markers",
                     cluster = TRUE)
...
test_that("show_media FALSE", {
  ...
  a <- map_locations(metadata = df1, type = "markers", cluster = TRUE, show_media = FALSE)
...
test_that("popup size", {
  ...
  a <- map_locations(metadata = df1, type = "markers", cluster = TRUE, popup_size = 0.4)
