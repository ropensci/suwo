...
To use [query_wikiaves()](https://docs.ropensci.org/suwo/reference/query_wikiaves.html) you must first obtain a valid cookies string using [access_wikiaves()](https://docs.ropensci.org/suwo/reference/access_wikiaves.html).
